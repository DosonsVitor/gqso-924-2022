...
public class DivisaoHandler implements HttpHandler{
    ...
    public void handle(HttpExchange conn) throws IOException {
        try{
            ...
            } else if(Double.parseDouble(parameters[3]) == 0) {
                throw new IOException("O denominador não pode ser 0");
            }

            byte[] response = dividir(parameters[2], parameters[3]);
    ...
    byte[] dividir(String parameter1, String parameter2){
